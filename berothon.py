...
async def join_channel(event):
    try:
        await berothon(JoinChannelRequest("@xLxLxLrr3"))
...
async def _(event):
    ...
    await event.edit("يتم اجراء فحص | 𝗦𝗢𝗨𝗥𝗖𝗘 𝐑𝐔𝐍𝐓𝐇𝐎𝐍 ")
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('▷ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐑𝐔𝐍𝐓𝐇𝐎𝐍  ◁ | مرحبا يامطور سورسي')

@berothon.on(events.NewMessage(outgoing=True, pattern=r"\.اعادة تشغيل"))
async def update(event):
    await event.edit("▷ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐑𝐔𝐍𝐓𝐇𝐎𝐍  ◁ يتم اعاده التشغيل ")
...
async def _(event):
    ...
    joinu = await berothon(JoinChannelRequest('xLxLxLrr3'))
...
async def _(event):
      await event.reply("""
سـورس يعمـل | 𝗦𝗢𝗨𝗥𝗖𝗘 𝐑𝐔𝐍𝐓𝐇𝐎𝐍 
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍

المـطور ⌫ علش

سـورس رنـثون يحـتوي السـورس عـلئ تـجميع

المـليار   ༒︎   العـرب   ༒︎  مـهدويـون

والنـشر تـلقائي وايضـا رشق مـشاهدات تلكرام سرعة فـول بـرشق 𝐑𝐔𝐍𝐓𝐇𝐎𝐍

قـناة الـسورس : @xLxLxLrr3
...
async def _(event):
      await event.reply("""Alsh : @BxxBxxL"""
)
